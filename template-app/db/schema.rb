...
ActiveRecord::Schema.define(version: 2024_01_30_165116) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.bigint "client_admin_id"
    t.boolean "should_reset_password", default: true
    t.string "location"
    t.string "job_title"
    t.boolean "can_create_accounts", default: false
    t.integer "pending_review_status"
    t.datetime "token_expires_at"
    t.string "session_duration"
    t.string "xero_id"
    t.boolean "email_enable", default: true
  ...
  create_table "bx_block_downloadoptions_download_options", force: :cascade do |t|
    t.string "title"
  end
  ...
  create_table "bx_block_privacy_settings_privacy_settings", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "consent_to"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_bx_block_privacy_settings_privacy_settings_on_account_id"
  end
  ...
  create_table "bx_block_teambuilder_team_members", force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.bigint "account_id"
    t.index ["account_id"], name: "index_bx_block_teambuilder_team_members_on_account_id"
  end
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.integer "catalogue_type", default: 0
  ...
  create_table "company_input_fields", force: :cascade do |t|
    t.bigint "company_id"
  ...
  create_table "company_sub_categories", force: :cascade do |t|
    t.bigint "company_id", null: false
    t.bigint "sub_category_id", null: false
    t.integer "price"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "default_coverages", force: :cascade do |t|
    t.string "title"
    t.integer "rank"
    t.integer "sub_category_id"
    t.integer "category"
  ...
  create_table "input_fields", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "section"
    t.index ["inputable_id", "inputable_type"], name: "index_input_fields_on_inputable_id_and_inputable_type"
  end
  ...
  create_table "input_values", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.json "input_field_data", default: {}
    t.integer "input_field_id"
    t.bigint "company_input_field_id"
    t.string "note"
  end
  ...
  create_table "inquiries", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.float "package_sub_total"
    t.float "addon_sub_total", default: 0.0
    t.float "extra_cost", default: 0.0
    t.integer "approved_by_client_admin_id"
    t.integer "approved_by_lf_admin_id"
    t.boolean "lf_admin_approval_required", default: false
    t.text "status_description"
    t.string "lf_admin_email"
  end
