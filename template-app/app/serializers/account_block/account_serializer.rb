module AccountBlock
  class AccountSerializer < BuilderBase::BaseSerializer
    attributes(:activated, :country_code, :email, :first_name, :full_phone_number, :country_code, :phone_number, :last_name, :phone_number, :type, :account_type, :client_admin_id, :device_id, :unique_auth_id, :should_reset_password)
